...
const std::string ERR_INVALIDCAPCMD_MSG = " :Invalid CAP subcommand\r\n";
...
/* ERR_ERRONEUSUSERNAME
    * 491 <username> :Erroneous username\r\n
    */
const std::string ERR_ERRONEUSUSERNAME = " 491 ";
const std::string ERR_ERRONEUSUSERNAME_MSG = " <username> :Erroneous username\r\n";
